                    ...
                    {certificates.map((cert, index) => (
                        ...
                        >
                            <div className="relative h-48 w-full overflow-hidden bg-white/5 p-8 flex items-center justify-center">
                                <div className="absolute inset-0 bg-cyber-black/20 group-hover:bg-transparent transition-colors duration-300" />
                                ...
                                <div className="relative h-full w-auto aspect-square">
                                    <Image
                                        ...
                                        fill
                                        sizes="192px"
                                        className="object-contain filter grayscale group-hover:grayscale-0 transition-all duration-500 transform group-hover:scale-110 drop-shadow-lg"
                                    />
                                </div>
                            ...
                            <div className="p-6 bg-cyber-gray/40 backdrop-blur-sm flex-grow border-t border-gray-800 relative">
                                ...
                                <div className="text-sm text-gray-400 font-sans mb-4">{cert.issuer}</div>
                                ...
                                <div className="absolute bottom-0 left-0 h-[2px] w-0 bg-cyber-primary group-hover:w-full transition-all duration-700 ease-in-out" />
                            </div>
                        </motion.div>
                    ))}
                </div>
